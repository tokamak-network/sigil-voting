...
export const en: Translations = {
  ...
  createPoll: {
    ...
    privacyGuideDesc: 'Use 1-5 minutes for testing. For real governance, 3+ days is recommended. Tallying starts automatically after the period ends.',
    ...
    quorumDesc: 'Voting starts immediately after creation. The coordinator automatically tallies and publishes results when the period ends.',
