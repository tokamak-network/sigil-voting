...
export const en: Translations = {
  ...
  landing: {
    ...
    title: 'Your Vote.\nYour Secret.',
    subtitle: 'Private token voting without exposing how each person voted. Bribery becomes hard to prove. Quadratic voting makes influence more fair.',
    enterApp: 'Launch App',
    ...
    features: {
      privacy: { title: 'Private Votes', sub: '', desc: 'Your vote is encrypted and never revealed. Only totals are published.' },
      coercion: { title: 'Bribe-Resistant', sub: '', desc: 'Change your voting key and re-vote. Bribers can\'t verify compliance.' },
      fairness: { title: 'More Fair', sub: '', desc: 'Quadratic voting makes extra influence cost more.' },
      verified: { title: 'ZK Verified', sub: '', desc: 'ZK proofs are published on-chain so the tally can be checked by anyone.' },
    },
    operationalFlow: 'How Privacy Is Guaranteed',
    lifecycle: {
      title: 'Three Layers of Protection',
      label: 'Three Security Layers',
      step1: { title: 'Encrypt', desc: 'Your vote is encrypted in the browser before it goes on-chain.' },
      step2: { title: 'Re‑Vote', desc: 'If coerced, change your key and re‑vote. The briber can’t tell.' },
      step3: { title: 'Verify', desc: 'The tally is published with a ZK proof. Manipulation fails verification.' },
    },
