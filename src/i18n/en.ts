...
export const en: Translations = {
  ...
  landing: {
    ...
    comparison: {
      ...
      erc20Support: 'ERC20 Token Support',
    ...
    advantages: {
      title: 'Built for Real-World DAOs',
      subtitle: 'SIGIL is not a demo. It\'s production infrastructure designed to work with your existing stack.',
