...
export const en: Translations = {
  ...
  landing: {
    ...
    title: 'Your Vote.\nYour Secret.',
    subtitle: 'Public token votes expose who voted what, let whales dominate, and invite censorship. SIGIL fixes it for communities, DAOs, and public goods.',
    enterApp: 'Launch App',
    heroStatus: 'Live on Ethereum testnet',
    heroVersion: 'By Tokamak Network',
    testnetNote: 'Open source · Free on testnet',
    ...
    integration: {
      ...
      step1Desc: 'Install from npm. TypeScript SDK with key management, encryption, and voting built in.',
    ...
    stats: {
      ...
      propertiesCount: '624',
      propertiesLabel: 'Max Voters / Poll',
      licenseCount: 'MIT',
      licenseLabel: 'Open Source',
    },
    established: 'EST. 2026',
    sdkIntegration: 'For Developers',
    demo: {
      title: 'Demo Video',
    ...
    roadmap: {
      ...
      phase2: { title: 'SDK v0.3.0 on npm', status: 'Complete' },
    ...
    advantages: {
      ...
      tokenGate: { title: 'Token-Gated Proposals', desc: 'Token holders above the threshold can create proposals. Governance stays in the hands of stakeholders.' },
      widget: { title: 'Embed Anywhere', desc: 'Add SIGIL voting to any website or app with a simple embed.' },
      autoTally: { title: 'Automatic Results', desc: 'Results are tallied and published automatically when voting ends. No manual steps.' },
      delegation: { title: 'Delegate Your Vote', desc: 'Can\'t participate in every vote? Delegate your voting power to someone you trust.' },
      execution: { title: 'Decisions Take Effect', desc: 'Passed proposals can automatically execute on-chain after a safety delay.' },
    },
    faq: {
      title: 'FAQ',
      ...
      a4: 'Not yet formally audited. The codebase is open source with 543 automated tests (frontend, SDK, and contract) and security properties aligned to MACI. Built on Ethereum PSE MACI research. A formal third-party audit is planned before mainnet.',
  ...
  voteForm: {
    ...
    firstVoteNote: 'First-time voters: 2 wallet approvals needed (registration + vote)',
  ...
  results: {
    title: 'Vote Results',
    desc: 'ZK-verified final results. Individual votes remain private.',
    passed: 'Passed',
    rejected: 'Rejected',
    tied: 'Tied',
    totalVoters: 'Voters',
  ...
  proposals: {
    ...
    subtitle: 'Cast your private vote. Results are automatically tallied when voting ends.',
